...
def _launch_nodes(context):
            ...
            + [
                {
                    ...
                    "reference_trials_csv": LaunchConfiguration("reference_trials_csv"),
                    "reference_trajectory_csv": LaunchConfiguration("reference_trajectory_csv"),
                    "reference_waypoints_yaml": LaunchConfiguration("reference_waypoints_yaml"),
                    "reference_audit_md": LaunchConfiguration("reference_audit_md"),
    ...
    rviz = Node(
            ...
            arguments=[
                "-d",
                os.path.join(experiment_share, "rviz", "reference_trajectory.rviz"),
            ],
            parameters=common,
    ...
    return [
        ...
        RegisterEventHandler(
            OnProcessExit(
                ...
                on_exit=[EmitEvent(event=Shutdown(reason="reference trajectory generator completed"))],
            )
        ),
    ]
...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "output_csv",
                default_value="/home/openarm/humanoid_sim_ws/validation/reference_internal_stages.csv",
            ),
            DeclareLaunchArgument(
                "summary_path",
                default_value="/home/openarm/humanoid_sim_ws/validation/reference_internal_summary.md",
            ),
            DeclareLaunchArgument(
                "target_history_csv",
                default_value="/home/openarm/humanoid_sim_ws/validation/reference_internal_history.csv",
            ),
            DeclareLaunchArgument(
                "extraction_clearance_csv",
                default_value="/home/openarm/humanoid_sim_ws/validation/reference_extraction_clearance.csv",
            ),
            DeclareLaunchArgument(
                "scene_translation_csv",
                default_value="/home/openarm/humanoid_sim_ws/validation/reference_scene_translation.csv",
            ),
            DeclareLaunchArgument("planning_attempt_id", default_value="offline_reference_generation_1"),
            DeclareLaunchArgument(
                "boundary_csv",
                default_value="/home/openarm/humanoid_sim_ws/validation/reference_internal_boundary.csv",
            ),
            DeclareLaunchArgument(
                "comparison_csv",
                default_value="/home/openarm/humanoid_sim_ws/validation/reference_internal_comparison.csv",
            ),
            DeclareLaunchArgument(
                "ik_audit_csv",
                default_value="/home/openarm/humanoid_sim_ws/validation/reference_internal_ik.csv",
            ),
            DeclareLaunchArgument(
                "geometric_csv",
                default_value="/home/openarm/humanoid_sim_ws/validation/reference_internal_geometric.csv",
            ),
            DeclareLaunchArgument(
            ...
            DeclareLaunchArgument(
                "repeat_trials_csv",
                default_value="/home/openarm/humanoid_sim_ws/validation/reference_internal_repeat.csv",
            ),
            DeclareLaunchArgument(
                "budget_sensitivity_csv",
                default_value="/home/openarm/humanoid_sim_ws/validation/reference_internal_budget.csv",
            ),
            DeclareLaunchArgument(
                "analysis_path",
                default_value="/home/openarm/humanoid_sim_ws/validation/reference_internal_analysis.md",
            ),
            DeclareLaunchArgument(
                "reference_trials_csv",
                default_value="/home/openarm/humanoid_sim_ws/validation/reference_generation_trials.csv",
            ),
            DeclareLaunchArgument(
                "reference_trajectory_csv",
                default_value="/home/openarm/humanoid_sim_ws/validation/reference_trajectory.csv",
            ),
            DeclareLaunchArgument(
                "reference_waypoints_yaml",
                default_value="/home/openarm/humanoid_sim_ws/validation/reference_stage_waypoints.yaml",
            ),
            DeclareLaunchArgument(
                "reference_audit_md",
                default_value="/home/openarm/humanoid_sim_ws/validation/reference_path_audit.md",
            ),
