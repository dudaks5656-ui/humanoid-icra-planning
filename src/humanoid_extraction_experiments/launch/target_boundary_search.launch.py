...
def _launch_nodes(context):
    ...
    experiment = Node(
            ...
            executable="target_boundary_search",
            output="screen",
            parameters=common
            + [
                {
...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "output_csv",
                default_value="/home/openarm/humanoid_sim_ws/validation/boundary_search_internal_stages.csv",
            ),
            DeclareLaunchArgument(
                "summary_path",
            ...
            DeclareLaunchArgument(
                "target_history_csv",
                default_value="/home/openarm/humanoid_sim_ws/validation/boundary_search_legacy_history.csv",
            ),
            DeclareLaunchArgument(
            ...
            DeclareLaunchArgument("planning_attempt_id", default_value="boundary_search_1"),
            DeclareLaunchArgument(
                "boundary_csv",
            ...
            DeclareLaunchArgument(
                "ik_audit_csv",
                default_value="/home/openarm/humanoid_sim_ws/validation/ik_multistart_audit.csv",
            ),
            DeclareLaunchArgument(
                "geometric_csv",
                default_value="/home/openarm/humanoid_sim_ws/validation/geometric_infeasibility_map.csv",
            ),
